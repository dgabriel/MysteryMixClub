...
class Settings(BaseSettings):
    ...
    # secret is generated by Resend only after the webhook endpoint is created
    # in its dashboard, so this stays empty (route 503s) until that's done.
    resend_webhook_secret: str = Field(default="")
    inbound_email_forward_to: str = Field(default="mysterymixclubspotify@gmail.com")
