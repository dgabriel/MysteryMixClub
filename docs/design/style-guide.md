...
Ten routes — `/login`, `/about`, `/terms`, `/privacy`, `/help`, `/home`,
`/clubs/:id`, `/mixes/:id`, `/clubs/new` and `/profile` — render on a **light**
surface. Everything else in the app is dark, exactly as the
