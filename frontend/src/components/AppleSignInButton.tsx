...
const APPLE_BUTTON_CLASS = [
  "flex h-11 min-w-0 items-center justify-center gap-2 rounded-[4px] px-3",
  "bg-black text-white",
  ...
  return (
    <>
      ...
      {/* truncate (not wrap): this sits in a half-width flex item next to
        GoogleSignInButton (MysteryMixClub-4vii.9/4vii.24) -- the fixed h-11
        height has no room for a wrapped second line, so a too-narrow screen
        ellipsizes the label instead of overflowing it. */}
