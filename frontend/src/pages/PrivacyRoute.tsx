        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-10 space-y-8 font-mono text-[13px] font-light leading-relaxed text-ink">
            ...
            <section>
              ...
              <p className="mt-3">
                delete your account any time from your profile page. this cascades to your
                submissions, votes, notes, sessions, and league memberships, with a scheduled hard
                purge of any remaining trace within 30 days. want a copy of your data instead of
                deleting it?{" "}
                <ContactEmail
                  user="privacy"
